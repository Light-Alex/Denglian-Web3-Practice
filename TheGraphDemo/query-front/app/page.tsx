...
import TOKEN_ABI from './contracts/MyToken.json';
import { parseUnits, formatUnits } from 'viem';
import { useQuery } from '@tanstack/react-query';
import { GraphQLClient, gql } from 'graphql-request';

// Counter 合约地址
const OPS_TOKEN_ADDRESS = "0x46F88fb8Bf00bA1Bb5516E70b3Ca5De5acb58D1c";
...
export default function Home() {
  ...
  const fetchRecords = async (addr: string) => {
    ...
    `;
    const client = new GraphQLClient('https://api.studio.thegraph.com/query/1741699/ops-token/version/latest');
