...
contract SimpleLeverageDEXTest is Test {
    ...
    function testClosePosition() public {
        ...
        assertEq(posMargin, 0, "Position margin should be 0 after closing");
        assertEq(position, 0, "Position should be 0 after closing");
    }
    
    function testLiquidation() public {
        uint256 margin = 500 * 1e6; // 1000 USDC
        ...
        // 模拟价格大幅下跌，触发清算条件
        vm.prank(user2);
        dex.openPosition(10000 * 1e6, 10, false); // 大额空仓，大幅推低价格
        
        // 检查是否可以清算
        bool canLiquidate = dex.isLiquidatable(user1);
        console.log("Is user1 liquidatable:", canLiquidate);
