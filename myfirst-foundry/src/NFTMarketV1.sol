 ...
 */
contract NFTMarketV1 is ReentrancyGuard, Initializable, ITokenReceiver {
    ...
    function permitBuy(
        ...
        IERC20Permit(address(paymentToken)).permit(msg.sender, address(this), listing.price, deadline, v, r, s);
