...
export const CONTRACT_ADDRESSES = {
  ...
  sepolia: {
    ...
    MyTokenPermit: process.env.NEXT_PUBLIC_MY_TOKEN_PERMIT_ADDRESS || '0x9332334303372163333333333333333333333333',
    MyNFTPermit: process.env.NEXT_PUBLIC_MY_NFT_PERMIT_ADDRESS || '0x9332334303372163333333333333333333333333',
  },
...
export function getContractAddress(
  chainId: number,
  contractName: 'BaseERC20' | 'NFTMarket' | 'SimpleNFT' | 'MyTokenPermit' | 'MyNFTPermit'
): string {
