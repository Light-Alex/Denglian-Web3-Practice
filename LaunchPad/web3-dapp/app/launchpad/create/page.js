    ...
    <div className="container py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">填写代币和销售信息，系统将自动部署合约</p>
        </div>
        ...
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-start">
            ...
            <div>
              <p className="font-semibold text-blue-800 mb-1">LaunchPad 说明</p>
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• 填写代币信息，系统将自动部署 ERC20 合约</li>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">通常为 18</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">每个代币的 USDC 价格</p>
                </div>
              </div>
          ...
          <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              <span className="font-semibold">平台手续费：</span>
              销售金额的 2%
            </p>
          </div>
